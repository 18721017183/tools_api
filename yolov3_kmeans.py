...
def compute_centroids(label_path,n_anchors,loss_convergence,grid_size,iterations_num,plus):
    ...
    # print result
    list1 = [[round(centroid.w * grid_size * 32), round(centroid.h * grid_size * 32)] for centroid in centroids]
    list1 = sorted(list1,key=lambda list2:list2[0]*list2[1])
    print(list1)
    for centroid in centroids:
...
label_path = "./tmp/2007_test_lnm_defect_20200708.txt"
n_anchors = 9
